...
export function JetLockup({ width = "168", height = "53", className, color = "currentColor" }: ISvgIcons) {
  return (
    <svg
      width={width}
      height={height}
      ...
      className={className}
    >
      <g clipPath="url(#clip0_jet)">
        {/* Geometric icon (preserved from original) */}
        <path
