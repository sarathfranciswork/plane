...
export default {
  ...
  support: "Wsparcie",
  forum: "Forum",
  powered_by_plane_pages: "Oparte na Jet Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Większość rzeczy zaczyna się od projektu w Jet.",
        cta: "Zacznij",
      },
      invite_team: {
        title: "Zaproś zespół",
  ...
  workspace_creation: {
    ...
    subheading: "Aby korzystać z Jet, musisz utworzyć lub dołączyć do przestrzeni roboczej.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Witaj w Jet, cieszymy się, że jesteś. Utwórz pierwszy projekt, śledź elementy pracy, a ta strona stanie się centrum Twojego postępu. Administratorzy zobaczą tu również elementy pomocne zespołowi.",
        primary_button: {
          text: "Utwórz pierwszy projekt",
          comic: {
            title: "Wszystko zaczyna się od projektu w Jet",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Skopiuj i zapisz ten klucz w Jet Pages. Po zamknięciu nie będzie widoczny ponownie. Plik CSV z kluczem został pobrany.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Używaj API, aby zintegrować Jet z zewnętrznymi systemami.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Jet będzie automatycznie archiwizował elementy, które zostały ukończone lub anulowane.",
        duration: "Archiwizuj elementy zamknięte dłużej niż",
      },
      "auto-close": {
        title: "Automatyczne zamykanie elementów",
        description: "Jet będzie automatycznie zamykał elementy, które nie zostały ukończone lub anulowane.",
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Jet nie uruchomił się. Może to być spowodowane tym, że jedna lub więcej usług Jet nie mogła się uruchomić.",
