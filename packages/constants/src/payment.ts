...
import type { IPaymentProduct, TBillingFrequency, TProductBillingFrequency } from "@jet/types";
...
export const PLANE_COMMUNITY_PRODUCTS: Record<string, IPaymentProduct> = {
  ...
  [EProductSubscriptionEnum.BUSINESS]: {
    ...
    name: "Jet Business",
    description:
      "The earliest packaging of Business at $10 a seat a month billed annually, $12 a seat a month billed monthly for Jet Cloud",
    type: "BUSINESS",
    prices: [
      {
