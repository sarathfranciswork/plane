...
import { SITE_DESCRIPTION, SITE_NAME } from "@jet/constants";
...
export const meta = () => [
  { title: "Jet | Modern, extensible, open-source project management tool." },
  ...
  { property: "og:title", content: "Jet | Modern, extensible, open-source project management tool." },
  {
  ...
  { property: "og:image:alt", content: "Jet - Modern project management" },
  { name: "twitter:site", content: "@planepowers" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: "https://app.plane.so/og-image.png" },
  { name: "twitter:image:width", content: "1200" },
  { name: "twitter:image:height", content: "630" },
  { name: "twitter:image:alt", content: "Jet - Modern project management" },
];
