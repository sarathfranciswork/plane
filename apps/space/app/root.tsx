...
const APP_TITLE = "Jet Publish | Make your Jet boards public with one-click";
const APP_DESCRIPTION = "Jet Publish is a project publishing tool built on top of Jet";
