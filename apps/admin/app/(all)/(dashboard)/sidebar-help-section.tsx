...
import { WEB_BASE_URL } from "@jet/constants";
// plane internal packages
import { GithubIcon, NewTabIcon, PageIcon } from "@jet/propel/icons";
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-1 ${isSidebarCollapsed ? "flex-col justify-center" : "w-full"}`}>
        <Tooltip tooltipContent="Redirect to Jet" position="right" className="ml-4" disabled={!isSidebarCollapsed}>
          <a
          ...
          >
            ...
            {!isSidebarCollapsed && "Redirect to Jet"}
          </a>
        </Tooltip>
